...
bool TypeDescriptor::support_join() const {
    ...
    return type != TYPE_JSON && type != TYPE_OBJECT && type != TYPE_PERCENTILE && type != TYPE_HLL && type != TYPE_VARIANT;
}
...
bool TypeDescriptor::support_orderby() const {
    ...
    return type != TYPE_JSON && type != TYPE_OBJECT && type != TYPE_PERCENTILE && type != TYPE_HLL && type != TYPE_MAP && type != TYPE_VARIANT;
}
